...
public class Autonomous_redleft extends Autonomous_Base {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence TrajectoryA2 = drive.trajectorySequenceBuilder(TrajectoryA1.end())
                ...
                .strafeLeft(90)
                .splineToLinearHeading(new Pose2d(66,-36,Math.toRadians(0)),Math.toRadians(0))
                .build();
        ...
        TrajectorySequence TrajectoryB2 = drive.trajectorySequenceBuilder(TrajectoryB1.end())
                .strafeLeft(90)
                .splineToLinearHeading(new Pose2d(66,-32,Math.toRadians(0)),Math.toRadians(0))
                .build();

        TrajectorySequence TrajectoryC1 = drive.trajectorySequenceBuilder(startPose)
                .forward(10)
                .lineToLinearHeading(new Pose2d(-47,-7,Math.toRadians(270)))
                .build();

        TrajectorySequence TrajectoryC2 = drive.trajectorySequenceBuilder(TrajectoryC1.end())
                .strafeLeft(90)
                .splineToLinearHeading(new Pose2d(64,-27,Math.toRadians(0)),Math.toRadians(25))
                .build();
...
//            drive.followTrajectorySequence(Trajectorypark);
    ...
    class YellowBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat preprocessFrame(Mat frame) {
            ...
            Imgproc.cvtColor(frame, hsvFrame, Imgproc.COLOR_RGB2HLS);

            Scalar lowerYellow = new Scalar(0, 0, 64);
            Scalar upperYellow = new Scalar(15, 161, 255);
