...
public class Autonomous_blueright extends Autonomous_Base {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence TrajectoryA2 = drive.trajectorySequenceBuilder(TrajectoryA1.end())
                ...
                .strafeRight(90)
                .splineToLinearHeading(new Pose2d(68,35,Math.toRadians(0)),Math.toRadians(0))
                .build();
        ...
        TrajectorySequence TrajectoryB2 = drive.trajectorySequenceBuilder(TrajectoryB1.end())
                .strafeRight(80)
                .splineToLinearHeading(new Pose2d(63,36,Math.toRadians(0)),Math.toRadians(0))
                .build();
        ...
        TrajectorySequence TrajectoryC2 = drive.trajectorySequenceBuilder(TrajectoryC1.end())
                .strafeRight(95)
                .splineToLinearHeading(new Pose2d(65,28,Math.toRadians(0)),Math.toRadians(25))
                .build();
