...
public class ThreeWheelLocalizer extends Localizer {
    ...
    // TODO: replace these with your encoder multipliers
    public static double FORWARD_TICKS_TO_INCHES = 0.0311;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.00052189;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.0031; //8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(148/25.4, 89/25.4, 0);
        rightEncoderPose = new Pose(148/25.4, -89/25.4, 0);
        strafeEncoderPose = new Pose(-168/25.4, 0/25.4, Math.toRadians(90));
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "FR"));
