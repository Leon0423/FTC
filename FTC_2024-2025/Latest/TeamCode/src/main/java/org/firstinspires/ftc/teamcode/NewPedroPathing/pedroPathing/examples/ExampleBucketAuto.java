package org.firstinspires.ftc.teamcode.NewPedroPathing.pedroPathing.examples;
...
public class ExampleBucketAuto extends OpMode {
    ...
    private final Pose parkControlPose = new Pose(60, 140);
    ...
    public void buildPaths() {
        ...
        park = new Path(
            new BezierCurve(
                new Point(scorePose),
                /* Control Point */ new Point(parkControlPose),
                new Point(parkPose)
            )
        );
