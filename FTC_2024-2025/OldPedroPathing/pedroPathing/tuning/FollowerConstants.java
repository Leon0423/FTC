...
import org.firstinspires.ftc.teamcode.OldPedroPathing.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.OldPedroPathing.pedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.OldPedroPathing.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 56.0661;
    private static double yMovement = 44.2474;
    ...
    public static double forwardZeroPowerAcceleration = -55.23003;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -68.46416;
