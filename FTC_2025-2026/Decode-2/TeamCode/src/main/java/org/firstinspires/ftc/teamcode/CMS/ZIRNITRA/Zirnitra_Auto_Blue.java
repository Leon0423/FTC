...
@Autonomous(name = "Zirnitra_Auto_Blue")
public class Zirnitra_Auto_Blue extends LinearOpMode {
    ...
    private static final double LOW_VELOCITY_RPM = 3500.0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            // 1. 啟動 Shooter (預熱)
            setShooterRPM(LOW_VELOCITY_RPM);
